...
require_once LUNIO_WP_PLUGIN_DIR . 'includes/class-lunio-updater.php';

// Initialize classes
$lunio_updater = new Lunio_Updater();
new Lunio_Admin( $lunio_updater );
